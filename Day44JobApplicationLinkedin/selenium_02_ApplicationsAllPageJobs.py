...
chrome_driver.get(url = "https://www.linkedin.com/jobs/search/?currentJobId=4092851967&distance=25&f_AL=true&f_E=1%2C2&f_WT=2&geoId=92000000&keywords=python%20intern&origin=JOBS_HOME_KEYWORD_HISTORY&refresh=true")
time.sleep(4)
...
all_listings = chrome_driver.find_elements(By.CSS_SELECTOR, value = '.job-card-containter--clickable')

for listing in all_listings:
    apply = chrome_driver.find_element(By.CSS_SELECTOR, value = ".jobs-s-apply button")
    apply.click()

    submit = chrome_driver.find_element(By.CSS_SELECTOR, value='button[aria-label = "Submit application"]')
